...
const Skills = () => {
  const skills = [
    ...
    { icon: <IoLogoJavascript />, name: "Javascripts" },
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="w-full py-4 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden"
    >
      {/* Background lights */}
      ...
      <motion.h2
        className="text-4xl mt-3 sm:text-5xl font-bold bg-clip-text text-transparent 
